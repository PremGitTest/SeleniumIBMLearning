...
public class Amazon_MoveToElementNValidate {
	...
	public void drapanddrop_Amazon() throws Exception {
		Thread.sleep(3000);
		...
		// driver.findElement(By.xpath("//span[contains(text(),'Create a Wish')]"));
